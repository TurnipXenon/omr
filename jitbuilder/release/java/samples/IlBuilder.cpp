...
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/Macros.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/BytecodeBuilder.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/IlBuilder.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/MethodBuilder.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/IlType.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/IlValue.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/ThunkBuilder.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/TypeDictionary.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/VirtualMachineOperandArray.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/VirtualMachineOperandStack.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/VirtualMachineRegister.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/VirtualMachineRegisterInStruct.hpp"
#include "/home/fauxeggplant/projects/omr/jitbuilder/release/cpp/include/VirtualMachineState.hpp"
...
void IlBuilder::Switch(IlValue * selectorValue, IlBuilder ** defaultBuilder, int32_t numCases, IlBuilder::JBCase ** cases) {
    ...
    static_cast<TR::IlBuilder *>(_impl)->Switch(static_cast<TR::IlValue *>(selectorValue != NULL ? selectorValue->_impl : NULL), defaultBuilderArg, numCases, casesArg);
    ARG_RETURN(IlBuilder, defaultBuilderImpl, defaultBuilder);
    ARRAY_ARG_RETURN(IlBuilder::JBCase, numCases, casesArg, cases);
}

void IlBuilder::Switch(IlValue * selectorValue, IlBuilder ** defaultBuilder, int32_t numCases, ...) {
...
void IlBuilder::TableSwitch(IlValue * selectorValue, IlBuilder ** defaultBuilder, bool generateBoundsCheck, int32_t numCases, IlBuilder::JBCase ** cases) {
    ARG_SETUP(IlBuilder, defaultBuilderImpl, defaultBuilderArg, defaultBuilder);
    ARRAY_ARG_SETUP(IlBuilder::JBCase, numCases, casesArg, cases);
    static_cast<TR::IlBuilder *>(_impl)->TableSwitch(static_cast<TR::IlValue *>(selectorValue != NULL ? selectorValue->_impl : NULL), defaultBuilderArg, generateBoundsCheck, numCases, casesArg);
    ARG_RETURN(IlBuilder, defaultBuilderImpl, defaultBuilder);
    ARRAY_ARG_RETURN(IlBuilder::JBCase, numCases, casesArg, cases);
}

void IlBuilder::TableSwitch(IlValue * selectorValue, IlBuilder ** defaultBuilder, bool generateBoundsCheck, int32_t numCases, ...) {
    IlBuilder::JBCase ** cases = new IlBuilder::JBCase *[numCases];
    va_list vararg;
    va_start(vararg, numCases);
    for (int i = 0; i < numCases; ++i) { cases[i] = va_arg(vararg, IlBuilder::JBCase *); }
